...
export const SunIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-6.364-.386 1.591-1.591M3 12h2.25m.386-6.364 1.591 1.591M12 12a2.25 2.25 0 0 0-2.25 2.25 2.25 2.25 0 0 0 2.25 2.25c.323.001.641-.062.941-.182a.748.748 0 0 1 .52.235 2.25 2.25 0 0 0 2.25 2.25c1.242 0 2.25-1.008 2.25-2.25a2.25 2.25 0 0 0-2.25-2.25c-.323-.001-.641.062-.941.182a.748.748 0 0 1-.52-.235A2.25 2.25 0 0 0 12 12Z" />
    </svg>
);
